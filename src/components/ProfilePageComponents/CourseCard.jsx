          ...
          <Card className="card-profile">
            ...
            <Card.Body className="card-profile-body">
              <h6 style={{width:"230px",whiteSpace:"nowrap", overflow:"hidden",textOverflow:"ellipsis"}}>{props.name}</h6>
                <Button as={Link} to={props.text ==='Resume' ? `course-content/${props.courseId}` : `course/${props.courseId}/certificate` } className="btn-profile" variant="primary" style={{ borderRadius: 12 }}>
                {props.text}
                </Button>
            </Card.Body>
          </Card>
