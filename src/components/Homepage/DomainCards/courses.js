  ...
  domains: [
    {
      ...
      description: "hello from AI",
      url: "https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fspecials-images.forbesimg.com%2Fdam%2Fimageserve%2F1129869424%2F960x0.jpg%3Ffit%3Dscale",
      course_list: [
        {
          id: 1,
          course_name: "react",
          description: "UI course",
    ...
    },
    {
      ...
      description: "hello from Web Dev",
      url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTO3abk_X67V6coNsK1sH6jX2134EVcmghK2w&usqp=CAU",
      course_list: [
        {
          id: 1,
          course_name: "React",
        ...
        },
        {
          id: 2,
          course_name: "Redux",
          description: "State Management course",
          src:
        ...
        },
        {
          ...
          description: "UI course",
          src:
            "https://z5b8q6f9.rocketcdn.me/wp-content/uploads/2018/08/angular-card.png",
          isEnrolled: false,
        },
        {
          id: 4,
          course_name: "HTML5 and CSS",
          description: "Lets get to the basics !",
          src:
        ...
        },
        {
          ...
          src:
            "http://logovectorseek.com/wp-content/uploads/2019/10/bootstrap-logo-vector.png",
          isEnrolled: false,
        },
        {
          id: 6,
          course_name: "Semantic UI",
          description: "Responsive Framework",
          src:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLOWTrvnesk3pmoDJBLs9Rozmul5xAmBFD9exSLhI0srZZs2NknNqdgK5h1wMEpsplkjg&usqp=CAU",
          isEnrolled: false,
        },
      ],
    },
  ],
  getDetails: function (category) {
    return this.domains.filter((domain) => domain.category === category);
  },
  //   getDomain:(domain)=>{
